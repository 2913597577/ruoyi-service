...
public class DcInsuranceCaseServiceImpl implements IDcInsuranceCaseService {
    ...
    private LambdaQueryWrapper<DcInsuranceCase> buildQueryWrapper(DcInsuranceCaseBo bo) {
        ...
        lqw.like(StringUtils.isNotBlank(bo.getPlaintiff()), DcInsuranceCase::getPlaintiff, bo.getPlaintiff());
        lqw.like(StringUtils.isNotBlank(bo.getDefendant()), DcInsuranceCase::getDefendant, bo.getDefendant());
        lqw.ge(bo.getSubjectAmount() != null, DcInsuranceCase::getSubjectAmount, bo.getSubjectAmount());
        lqw.eq(StringUtils.isNotBlank(bo.getCaseReason()), DcInsuranceCase::getCaseReason, bo.getCaseReason());
        lqw.like(StringUtils.isNotBlank(bo.getJurisdictionCourt()), DcInsuranceCase::getJurisdictionCourt, bo.getJurisdictionCourt());
        lqw.ge(bo.getPremium() != null, DcInsuranceCase::getPremium, bo.getPremium());
        lqw.eq(StringUtils.isNotBlank(bo.getRemark()), DcInsuranceCase::getRemark, bo.getRemark());
        lqw.eq(StringUtils.isNotBlank(bo.getRemark1()), DcInsuranceCase::getRemark1, bo.getRemark1());
        lqw.eq(StringUtils.isNotBlank(bo.getRemark2()), DcInsuranceCase::getRemark2, bo.getRemark2());
        lqw.eq(StringUtils.isNotBlank(bo.getRemark3()), DcInsuranceCase::getRemark3, bo.getRemark3());
