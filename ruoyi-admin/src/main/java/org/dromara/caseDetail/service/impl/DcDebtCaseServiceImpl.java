...
public class DcDebtCaseServiceImpl implements IDcDebtCaseService {
    ...
    private LambdaQueryWrapper<DcDebtCase> buildQueryWrapper(DcDebtCaseBo bo) {
        ...
        lqw.ge(bo.getDebtAmount() != null, DcDebtCase::getDebtAmount, bo.getDebtAmount());
        lqw.ge(bo.getRemainingAmount() != null, DcDebtCase::getRemainingAmount, bo.getRemainingAmount());
