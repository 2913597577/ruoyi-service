...
@AutoMapper(target = DcSalescenterPerformanceTask.class, reverseConvertGenerate = false)
public class DcSalescenterPerformanceTaskBo extends BaseEntity {
     ...
     * 销售中心id
     */
    @NotNull(message = "销售中心id不能为空", groups = {AddGroup.class, EditGroup.class})
     ...
     * 销售中心id集合
     */
    private List<Long> salesCenterIds;
