...
@AutoMapper(target = DcCustomerRiskRefund.class)
public class DcCustomerRiskRefundVo implements Serializable {
     ...
     * 1-风险 2-退费
     */
    @ExcelProperty(value = "1-风险 2-退费")
    private Integer customerType;

    /**
     * 风险/退费原因
     */
    @ExcelProperty(value = "风险/退费原因")
