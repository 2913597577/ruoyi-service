...
/**
 * 员工岗位变动申请对象 dc_employee_position_change
 */
@Data
@EqualsAndHashCode(callSuper = true)
@TableName("dc_employee_position_change")
public class DcEmployeePositionChange extends BaseEntity {
    ...
    /**
     * 岗位变动类型：部门调动、职级晋升、职级降低、转正、离职、其他
     */
     ...
     * 现岗位任职日期
     */
    private Date currentPositionEntryDate;
    ...
    /**
     * 岗位变动主要原因：业务发展需要、个人能力发展、绩效表现优异、组织架构调整、不胜任原岗、个人申请（多选用逗号分隔）
     */
